...
export const translations: Record<Lang, TranslationTree> = {
  de: {
    ...
    claimProcess: {
      title: 'Schadenmeldung',
      subtitle: 'Chatbot-Flow mit Standortabfrage, Zeitstempelung und strukturierter Schadenaufnahme.',
      ...
      infoSubtitle: 'Aktuelle Eckdaten zur Schadenakte.',
  ...
  en: {
    ...
    claimProcess: {
      title: 'Claims Process',
      subtitle: 'Chatbot flow with location capture, timestamps, and structured claim intake.',
      ...
      infoTitle: 'Live check',
      infoSubtitle: 'Current data points for the claim file.',
