...
export const translations: Record<Lang, TranslationTree> = {
  de: {
    ...
    analysis: {
      kairos: {
        title: 'Kairos Risk Solutions (Singapur) – Strategische Partner-/Wettbewerbsanalyse für Insurfox',
        subtitle: 'Parametrische Risikolösungen und Specialty-Insurance-Consulting vs. Insurfox (MGA-/Broker-/Plattform-Hybrid)',
        export: 'Executive Report (PDF) herunterladen',
        executiveSummary: 'Executive Summary',
        summaryP1: 'Kairos Risk Solutions ist ein spezialisierter Anbieter für Risikolösungen und Consulting mit Hauptsitz in Singapur, mit sichtbarer Stärke in parametrischer Versicherung und Specialty-Risikostrukturierung.',
        summaryP2: 'Im Vergleich zu Insurfox liegt Kairos stärker auf Beratungs- und Strukturierungsebenen der Wertschöpfung, statt als Carrier oder Full-Stack-Operator aufzutreten.',
        summaryP3: 'Die zentrale Chance für Insurfox liegt in der schnelleren Entwicklung klima- und ereignisgetriebener parametrischer Produkte für die Segmente Logistics, Fleet und Mobility.',
        summaryP4: 'Das zentrale Risiko entsteht bei einer Rollenverschiebung von Kairos Richtung MGA-/Maklerdistribution mit wachsender Überschneidung bei Kundenzugang und Datenhoheit.',
        companyProfiles: 'Unternehmensprofil',
        kairosSnapshot: 'Kairos RS Snapshot',
        insurfoxSnapshot: 'Insurfox Snapshot',
        offeringsDeepDive: 'Angebote und Capability-Deep-Dive',
        offeringsParametricTitle: 'Capability in parametrischer Versicherung',
        offeringsParametricBody: 'Fokus auf trigger- und indexbasierte Produktlogik, Basisrisiko-Management und klimabezogene Exponierungsmodellierung.',
        offeringsSpecialtyTitle: 'Exposure in Specialty-Lines',
        offeringsSpecialtyBody: 'Öffentlich genannte Schwerpunkte umfassen Agriculture, Forestry, Credit & Surety sowie Business-Risk-Versicherung.',
        offeringsOpsTitle: 'Operatives Enablement',
        offeringsOpsBody: 'Consulting plus Lösungen in Finance/Administration mit öffentlicher Kommunikation zu KI-integrierten Lösungen für 2026.',
        offeringsMappingTitle: 'Vertikales Mapping zu Insurfox',
        offeringsMappingBody: 'Der höchste Fit zeigt sich in Logistics/Fleet/Mobility über parametrisches Produktdesign, Trigger-Governance und risikobasierte Portfoliosteuerung.',
        positionMatrix: 'Wettbewerbs-/Partnerschafts-Positionsmatrix',
        overlapAxis: 'Wettbewerbliche Überschneidung',
        valueAxis: 'Strategischer Wert',
        matrixInterpretation: 'Interpretation: Kairos ist besonders wertvoll als Partner für Risikostrukturierung und parametrisches Co-Building. Direkter Wettbewerbsdruck steigt primär bei Eintritt in Distribution oder MGA-nahe Execution.',
        ...
        fitDistributionSynergy: 'Distributionssynergie',
        fitGovernanceReadiness: 'Regulatorische Governance-Reife',
        financialScenario: 'Finanz-/Szenariomodell',
        premiumVolume: 'Prämienvolumen (EUR Mio.)',
        attachRate: 'Parametrische Attach-Rate (%)',
        lossRatio: 'Erwartete Schadenquote (%)',
        commissionRate: 'Courtage-/Provisionssatz (%)',
        commissionIncome: 'Courtage-/Provisionsertrag',
        uwMarginProxy: 'Underwriting-Margen-Proxy',
        ...
        sensitivityTitle: 'Sensitivität: Schadenquote vs. Ergebnisbeitrag',
        sensitivitySeries: 'Ergebnisbeitrag (EUR Mio.)',
        riskGovernanceHeatmap: 'Risk-&-Governance-Heatmap',
        likelihood: 'Wkt.',
        impact: 'Imp.',
        score: 'Score',
        strategicOptions: 'Strategische Optionen (Board-Ebene)',
        option: 'Option',
        risk: 'Risiko',
        control: 'Kontrolle',
        capital: 'Kapital',
        ...
        next306090: 'Empfohlene nächsten 30/60/90 Tage',
        needFromKairos: 'Was wir von Kairos benötigen',
        offerFromInsurfox: 'Was wir anbieten (Insurfox)',
        contacts: 'Wichtige, in öffentlichen Quellen genannte Personen',
        ...
        contactAddress: 'Adresse (Singapur)',
        sources: 'Quellen',
